...
local fileManager = "kitty -e bash -ic yazi"
...
local mainMod = "SUPER" -- Sets "Windows" key as main modifierd

-- Free Letters:  B  C  D  F  G  H  I  K  L  N  O  R  T  U  X  Y  SPACE  TAB  +SHIFT
...
hl.bind(
	mainMod .. " + X",
	hl.dsp.exec_cmd([[sh -c 'pgrep -x waybar >/dev/null && pkill -x waybar || waybar >/dev/null 2>&1 &']])
)
